...
# :heavy_check_mark: kyopro/test/cumulative-sum_yosupo-judge.test.cpp
...
{% raw %}
```cpp
#line 1 "kyopro/test/cumulative-sum_yosupo-judge.test.cpp"
﻿#define PROBLEM "https://judge.yosupo.jp/problem/static_range_sum"
...
#line 6 "kyopro/test/cumulative-sum_yosupo-judge.test.cpp"
