...
data:
  ...
  bundledCode: "#line 1 \"kyopro/test/template_yosupo-judge.test.cpp\"\n#define PROBLEM\
  ...
  verifiedWith: []
documentation_of: kyopro/test/template_yosupo-judge.test.cpp
layout: document
redirect_from:
- /verify/kyopro/test/template_yosupo-judge.test.cpp
- /verify/kyopro/test/template_yosupo-judge.test.cpp.html
